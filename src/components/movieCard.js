...
function MovieCard({ movie }) {
  const [addToFavorites, { isLoading }] = addToFavorites();
        ...
        <div className="col-lg-2 mb-4">
            <div className="card">
                ...
                <div className="card-body">
                    <h5 className="card-title "><span>{movie.title.substring(0,200)}</span></h5><span className="far fa-star" aria-hidden="true" onClick={handleAddToFavorites}></span><span className="ml-1">{movie.vote_average}</span>
